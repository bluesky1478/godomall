    ...
    $(document).ready(function () {
        ...
        $('.js-excel-guide').on('click', function () {
            BootstrapDialog.show({
                title: '관련 법적 고지 안내',
                message: '<span class="text-blue bold">방송통신위원회고시 ‘개인정보의 기술적·관리적 보호조치 기준’ 제6조 4항</span><br/><br/><span class="bold">제6조(개인정보의 암호화)</span><br/>④ 정보통신서비스 제공자등은 이용자의 개인정보를 컴퓨터, 모바일 기기 및 보조저장매체 등에 저장할 때에는 이를 암호화해야 한다.<br/><br/><span class="text-blue bold">개인정보의 기술적·관리적 보호조치 기준</span><br/><br/><span class="bold">제4조(접근통제)</span><br/>⑧ 정보통신서비스 제공자등은 개인정보취급자를 대상으로 다음 각 호의 사항을 포함하는 비밀번호 작성규칙을 수립하고, 이를 적용․운용하여야 한다.<br/>1. 영문, 숫자, 특수문자 중 2종류 이상을 조합하여 최소 10자리 이상 또는 3종류 이상을 조합하여 최소 8자리 이상의 길이로 구성',
                buttons: [{
...
<form id="frmExcelForm" name="frmExcelForm" action="../share/layer_excel_ps.php" method="post">
    ...
    <table class="table table-cols no-title-line">
        ...
        <tr id="js-excel-form-password">
            ...
            <td>
                <div class="form-inline">
                    <input type="text" name="password" class="form-control width-xl js-type-normal" placeholder="영문/숫자/특수문자 2개 포함, 10~16자"/></label>
                </div>
            </td>
            <th>비밀번호 확인</th>
            <td>
