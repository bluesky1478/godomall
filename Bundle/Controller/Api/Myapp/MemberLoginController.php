 ...
 */
class MemberLoginController extends \Controller\Api\MyappController
{
    /**
     * {@inheritDoc}
     */
        ...
        try {
            switch ($this->method) {
                case Request::METHOD_GET:
                    $loginInfo = $myappApi->getMemberLoginInfo();
                    $this->httpCode = Response::HTTP_OK;
                    $this->myappResult = json_encode($loginInfo, JSON_UNESCAPED_UNICODE);
                    break;
            }
        } catch (Exception $e) {
