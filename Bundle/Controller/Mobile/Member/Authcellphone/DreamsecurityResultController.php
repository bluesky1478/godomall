...
class DreamsecurityResultController extends \Controller\Mobile\Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $strAge = NumberUtils::ageCalculator($strBirthDate);    // 만나이
            ...
            if ($strResult == 'success' && NumberUtils::ageCalculator($strBirthDate, 2) >= 20) {
        ...
        if(strpos($userAgentInfo,"iPhone") !== false &&(strpos($userAgentInfo,"FBAN")!== false || Strpos($userAgentInfo,"FBAV") !== false)) {
